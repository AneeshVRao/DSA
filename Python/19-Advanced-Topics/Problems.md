# Practice Problems - 19 Advanced Topics (Python)
...
| 5 | Most Stones Removed with Same Row or Column | Union by row and column. | [LeetCode 947](https://leetcode.com/problems/most-stones-removed-with-same-row-or-column/) |
...
| 8 | Count of Smaller Numbers After Self | Fenwick over value ranks, scanning right to left. | [LeetCode 315](https://leetcode.com/problems/count-of-smaller-numbers-after-self/) |
| 9 | Range Sum Query 2D - Mutable | 2-D Fenwick. | [LeetCode 308](https://leetcode.com/problems/range-sum-query-2d-mutable/) |
| 10 | Reverse Pairs | Fenwick or merge-sort counting. | [LeetCode 493](https://leetcode.com/problems/reverse-pairs/) |
| 11 | The Skyline Problem | Segment tree, or a sweep with a heap. | [LeetCode 218](https://leetcode.com/problems/the-skyline-problem/) |
