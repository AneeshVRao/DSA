# Practice Problems - 19 Advanced Topics (C++)
...
| 2 | Redundant Connection | The first edge whose union fails closes a cycle. | [LeetCode 684](https://leetcode.com/problems/redundant-connection/) |
| 3 | Accounts Merge | Union by shared email, then group by root. | [LeetCode 721](https://leetcode.com/problems/accounts-merge/) |
| 4 | Most Stones Removed | Union by row and column index. | [LeetCode 947](https://leetcode.com/problems/most-stones-removed-with-same-row-or-column/) |
